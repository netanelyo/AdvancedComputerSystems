    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                Log.d("Nati", "Before display serv!   " + mBluetoothLeService);
                initializeCharacteristic(mBluetoothLeService.getSupportedGattServices());
                Log.d("Nati", "Before display char!   " + mWriteCharacteristic);
...
////                    LIST_NAME, Constants.lookup(uuid, unknownServiceString));
...
////                        LIST_NAME, Constants.lookup(uuid, unknownCharaString));
